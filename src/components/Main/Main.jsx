...
function Main() {
    ...
    const [sortOption, setSortOption] = useState({name: "популярности",
        sortOption: "rating"
    })
        ...
        <div className="content">
            <div className="container">
                <div className="content__top">
                    ...
                    <Sort asc={asc} setAsc={setAsc} sortOptions={sortOptions} sortOption={sortOption} setSortOption={(index)=> setSortOption(index)}/>
                </div>
